...
uint8_t gb31Pin = 12; // VIN/AUD_IN & IRQ -> Ar_Pin15 PB4 D12 https://github.com/rust-console/gbatek-gbaonly/blob/gh-pages/index.md#gbainterruptcontrol
...
void setup() {
  ...
  pinMode(gb31Pin, OUTPUT); // audio/IRQ
...
void EXTI0_IRQHandler(void) { // https://dhole.github.io/post/gameboy_cartridge_emu_2/

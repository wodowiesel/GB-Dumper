...
uint8_t gb31Pin = 12;   // VIN/AUD_IN & -> Ar_Pin15 PB4 D12 MISO https://github.com/rust-console/gbatek-gbaonly/blob/gh-pages/index.md#gbainterruptcontrol
...
uint8_t AudioPin = A2;  //  AUDIO_IN DMG -> Ar_PIN21
...
void IRQ_GBA(void) { // digital active-high
  Serial.println("IRQ check ");
  // IRQ_on(void); // jump to irq handler
}
